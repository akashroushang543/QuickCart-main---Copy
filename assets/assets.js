...
//   return (
//     // <svg className="w-5 h-5 text-text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
//     //   </defs>
//     // </svg>
//     <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-800">
...
import star_dull_icon from "./star_dull_icon.svg";
import header_headphone_image from "./header_headphone_image.png";
import console from "./console.gif";
import header_playstation_image from "./header_playstation_image.png";
import header_macbook_image from "./header_macbook_image.png";
